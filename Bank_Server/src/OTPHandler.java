...
public class OTPHandler extends Thread {
    ...
    OTPHandler(String pno) {
        ...
        url = String.format("http://control.msg91.com/api/sendotp.php?authkey=249243A7rlMFbL5bfceb1a&message=Your OTP is %s&sender=SHBZOTP&mobile=91%s&otp=%s", new String(c), pno, new String(c));
